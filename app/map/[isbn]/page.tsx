...
export default function MapPage({ params, searchParams }: MapPageProps) {
  ...
  <p className="text-sm text-gray-400">
    📚 다음 장을 쓰는 중
    <span style={{ animation: 'dotFade 2.5s ease-in-out 0s infinite' }}>.</span>
    <span style={{ animation: 'dotFade 2.5s ease-in-out 0.4s infinite' }}>.</span>
    <span style={{ animation: 'dotFade 2.5s ease-in-out 0.8s infinite' }}>.</span>
  </p>
</div>
